...
def soft_process_som(smi):
    ...
    dic_ligand = dict(
        ligand_node_features=ligand_node_features,
        ligand_edge_features=ligand_edge_features,
        ligand_coor_true=np.zeros((ligand_node_features.shape[0], 3)),
        ligand_match=ligand_match,
        ligand_dismap=np.zeros((ligand_node_features.shape[0], ligand_node_features.shape[0])),
        ligand_CR=ligand_CR,
    )
